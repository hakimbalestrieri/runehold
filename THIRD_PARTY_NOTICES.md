...
| [`Dava96/osrs-icons`](https://github.com/Dava96/osrs-icons) | inspected online | README identifies icons as Jagex/OSRS Wiki property and references CC BY-NC-SA material. | Rejected; no icons copied. |
| [`osrsbox/osrsbox-db`](https://github.com/osrsbox/osrsbox-db) | inspected online | Code and data licences do not grant ownership of Jagex game assets. | Rejected; no data or images copied. |
